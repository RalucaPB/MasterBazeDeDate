...
public class MainWindow extends UnicastRemoteObject implements Serializable, Observer {
    ...
    @FXML
    public void OpenQuery(ActionEvent ev) throws IOException {
        try{
            //FXMLLoader fxmlLoader=new FXMLLoader(getClass().getResource("CreateDB.fxml"));
            // FXMLLoader fxmlLoader = new FXMLLoader(CreateDB.class.getResource("../../../resources/CreateDB.fxml"));
            // fxmlLoader.setLocation(getClass().getResource("C:/Users/Raluca/Documents/masterBD/AN1/ISGBD/final/LabISGBD/Client/src/main/resources/CreateDB.fxml"));
            ...
            fxmlLoader.setLocation(getClass().getResource("../../resources/Query.fxml"));
            //System.out.println(getClass().getResource("C:\\Users\\Raluca\\Documents\\masterBD\\AN1\\ISGBD\\final\\LabISGBD\\Client\\src\\main\\resources\\CreateDB.fxml"));
            System.out.println(getClass().getResource("../../resources/Query.fxml"));
            Parent root1=(Parent) fxmlLoader.load();
            Stage stage=new Stage();
            stage.setScene(new Scene(root1));
            stage.show();
            Query ctrl = fxmlLoader.getController();
            ctrl.setService(service,p.getDatabaseName());
        } catch (Exception e) {
            Alert errorAlert = new Alert(Alert.AlertType.ERROR);
            errorAlert.setHeaderText("ERROR!");
            errorAlert.setContentText("The window could not be opened!");
    ...
    @FXML
    public void OpenJoin(ActionEvent ev) throws IOException {
        try{
            //FXMLLoader fxmlLoader=new FXMLLoader(getClass().getResource("CreateDB.fxml"));
            // FXMLLoader fxmlLoader = new FXMLLoader(CreateDB.class.getResource("../../../resources/CreateDB.fxml"));
            // fxmlLoader.setLocation(getClass().getResource("C:/Users/Raluca/Documents/masterBD/AN1/ISGBD/final/LabISGBD/Client/src/main/resources/CreateDB.fxml"));
            ...
            fxmlLoader.setLocation(getClass().getResource("../../resources/JoinView.fxml"));
            //System.out.println(getClass().getResource("C:\\Users\\Raluca\\Documents\\masterBD\\AN1\\ISGBD\\final\\LabISGBD\\Client\\src\\main\\resources\\CreateDB.fxml"));
            System.out.println(getClass().getResource("../../resources/Query.fxml"));
            Parent root1=(Parent) fxmlLoader.load();
            Stage stage=new Stage();
            stage.setScene(new Scene(root1));
            stage.show();
            JoinView ctrl = fxmlLoader.getController();
            ctrl.setService(service,p.getDatabaseName());
        } catch (Exception e) {
            Alert errorAlert = new Alert(Alert.AlertType.ERROR);
            errorAlert.setHeaderText("ERROR!");
    ...
    @FXML
    public void OpenCreateTable(ActionEvent ev) throws IOException {
        try{
            //FXMLLoader fxmlLoader=new FXMLLoader(getClass().getResource("CreateDB.fxml"));
            // FXMLLoader fxmlLoader = new FXMLLoader(CreateDB.class.getResource("../../../resources/CreateDB.fxml"));
            // fxmlLoader.setLocation(getClass().getResource("C:/Users/Raluca/Documents/masterBD/AN1/ISGBD/final/LabISGBD/Client/src/main/resources/CreateDB.fxml"));
            ...
            fxmlLoader.setLocation(getClass().getResource("../../resources/CreateTable.fxml"));
            //System.out.println(getClass().getResource("C:\\Users\\Raluca\\Documents\\masterBD\\AN1\\ISGBD\\final\\LabISGBD\\Client\\src\\main\\resources\\CreateDB.fxml"));
            System.out.println(getClass().getResource("../../resources/CreateTable.fxml"));
            Parent root1=(Parent) fxmlLoader.load();
            Stage stage=new Stage();
            stage.setScene(new Scene(root1));
            stage.show();
            CreateTable ctrl = fxmlLoader.getController();
            ctrl.setService(service,p.getDatabaseName());
        } catch (Exception e) {
            Alert errorAlert = new Alert(Alert.AlertType.ERROR);
            errorAlert.setHeaderText("ERROR!");
    ...
    @FXML
    public void OpenTables(ActionEvent ev) throws IOException {
        try{
            //FXMLLoader fxmlLoader=new FXMLLoader(getClass().getResource("CreateDB.fxml"));
            // FXMLLoader fxmlLoader = new FXMLLoader(CreateDB.class.getResource("../../../resources/CreateDB.fxml"));
            // fxmlLoader.setLocation(getClass().getResource("C:/Users/Raluca/Documents/masterBD/AN1/ISGBD/final/LabISGBD/Client/src/main/resources/CreateDB.fxml"));
            ...
            fxmlLoader.setLocation(getClass().getResource("../../resources/TableView.fxml"));
            //System.out.println(getClass().getResource("C:\\Users\\Raluca\\Documents\\masterBD\\AN1\\ISGBD\\final\\LabISGBD\\Client\\src\\main\\resources\\CreateDB.fxml"));
            System.out.println(getClass().getResource("../../resources/TableView.fxml"));
            Parent root1=(Parent) fxmlLoader.load();
            Stage stage=new Stage();
            stage.setScene(new Scene(root1));
            stage.show();
            TableViewC ctrl = fxmlLoader.getController();
            ctrl.setService(service,p.getDatabaseName());
        } catch (Exception e) {
            Alert errorAlert = new Alert(Alert.AlertType.ERROR);
            errorAlert.setHeaderText("ERROR!");
